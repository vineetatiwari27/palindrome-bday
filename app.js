...
var dateInputRef = document.querySelector('#bday');
var showBtnRef = document.querySelector('#check');
var resultRef = document.querySelector('#conclusion');



showBtnRef.addEventListener('click', function clickHandler() {
